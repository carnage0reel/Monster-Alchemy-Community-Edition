...
# 🎮 Monster Alchemy — Community Edition

**Brew, collect, and battle creatures in a standalone community build.**
...
Monster Alchemy is a monster-collecting RPG centered on alchemy, where players brew formulas, combine ingredients, and create unique creatures to explore and battle with. This Community Edition is a standalone build distributed as a self-contained package. It requires no storefront and no additional software, and it is ready to play immediately after installation.

This standalone build is intended for players who want a self-contained offline version of Monster Alchemy with all content included.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4013510/3444f164db27d199a7205d5c762626f86c6d518b/ss_3444f164db27d199a7205d5c762626f86c6d518b.1920x1080.jpg?t=1789346794" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4013510/c146b87af5179ab1ec029830ec23abb6e1d8db83/ss_c146b87af5179ab1ec029830ec23abb6e1d8db83.1920x1080.jpg?t=1789346794" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4013510/3d54bbe39fc407f40dd4efc09ce09951f586ae33/ss_3d54bbe39fc407f40dd4efc09ce09951f586ae33.1920x1080.jpg?t=1789346794" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ⚗️ **Alchemy Crafting System** — Combine ingredients and formulas to create new monster species.
- 🧬 **Monster Fusion** — Merge captured creatures to produce hybrids with inherited traits.
- ⚔️ **Turn-Based Combat** — Strategic battles built around elemental types and status effects.
- 🗺️ **Exploration** — Travel across regions to discover rare ingredients and wild monsters.
- 📖 **Creature Compendium** — Record every discovered species, formula, and evolution path.
- 🛠️ **Workshop Upgrades** — Improve cauldrons and tools to enable higher-tier recipes.
- 🏆 **Quests and Challenges** — Complete story missions and optional trials across the campaign.
- 💾 **Offline Play** — Full single-player experience that runs without an internet connection.
- 🎮 **Controller Support** — Play with keyboard, mouse, or a compatible gamepad.
- 📦 **Self-Contained Package** — Includes all content in one build with no additional downloads.
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 750 Ti or AMD Radeon RX 550 | NVIDIA GeForce GTX 1060 or AMD Radeon RX 580 |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\MonsterAlchemy\Saved`
